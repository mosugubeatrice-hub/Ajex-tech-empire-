    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 pt-24 pb-12">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            { title: "Your Profile", href: "/dashboard/profile", description: "Manage your account details" },
            { title: "Your Projects", href: "/dashboard/projects", description: "View your active projects" },
            {
              title: "Invoices",
              href: "/dashboard/invoices",
              description: "View and manage your invoices",
            },
            { title: "Support", href: "/contact", description: "Get in touch with our team" },
          ].map((section, i) => (
