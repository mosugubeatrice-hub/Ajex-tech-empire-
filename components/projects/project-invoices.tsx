...
export function ProjectInvoices({ invoices, projectId }: ProjectInvoicesProps) {
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>Project Invoices ({invoices.length})</span>
          </CardTitle>
        ...
        {totalRevenue > 0 && (
          <div className="text-sm text-slate-600">
            Total Billed: <span className="font-semibold text-green-600">${totalRevenue.toLocaleString()}</span>
          </div>
        )}
      </CardHeader>
      <CardContent>
        {invoices.length > 0 ? (
          ...
          <div className="text-center py-8 text-slate-500">
            ...
            <p>No invoices yet</p>
            <p className="text-sm">Create an invoice for this project</p>
          </div>
        )}
      </CardContent>
    </Card>
